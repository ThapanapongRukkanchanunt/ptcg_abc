...
By default, Limitless pages are filtered to `TEF-POR`, matching the selected competition workflow format. Override only when intentionally checking another format:

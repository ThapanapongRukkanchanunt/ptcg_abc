...
# Copied from Kiyotah's Kaggle notebook and adapted for local benchmarking.
# Source: https://www.kaggle.com/code/kiyotah/a-sample-rule-based-agent-dragapult-ex-deck
# Kaggle scriptVersionId: 327783382
import os
import sys
...
# Sample Dragapult deck reconstructed from the notebook deck constants.
SAMPLE_DRAGAPULT_DECK = [
    119, 119, 119, 119, 120, 120, 120, 120, 121, 121,
    121, 140, 184, 235, 235, 1071, 1079, 1079, 1080, 1086,
...
my_deck = list(SAMPLE_DRAGAPULT_DECK)
...
class SampleDragapultAgent:
    """Adapter around the copied Dragapult sample agent for local simulator benchmarks."""

    deck_ids = SAMPLE_DRAGAPULT_DECK
